...
<head>
    ...
    <title>Paket Plan - BillNesia</title>
...
<body
    ...
    <!-- Pricing Section -->
    <div class="bg-white dark:bg-slate-900 py-24 sm:py-32 transition-colors duration-300" x-data="{ cycle: 'monthly' }">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-4xl text-center">
                ...
                <p class="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400">Tingkatkan efisiensi manajemen
                    RT-RW Net Anda dengan fitur premium kami.</p>
            </div>

            <!-- Cycle Toggle -->
            <div class="mt-12 flex justify-center">
                <div class="relative flex bg-slate-100 dark:bg-slate-800 p-1 rounded-2xl">
                    <button @click="cycle = 'monthly'"
                        ...
                        class="px-6 py-2 rounded-xl text-sm font-bold transition-all">Bulanan</button>
                    <button @click="cycle = 'semester'"
                        ...
                        class="px-6 py-2 rounded-xl text-sm font-bold transition-all">6 Bulan</button>
                    <button @click="cycle = 'annual'"
                        ...
                        class="px-6 py-2 rounded-xl text-sm font-bold transition-all">Tahunan</button>
                </div>
            </div>
            ...
            <div class="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                @foreach($plans as $p)
                    <div
                        class="flex flex-col justify-between rounded-3xl bg-white dark:bg-slate-800 p-8 ring-1 ring-slate-200 dark:ring-white/10 shadow-xl transition-all hover:scale-[1.02]">
                        <div>
