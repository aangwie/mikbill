            ...
            <div class="flex h-16 justify-between items-center">
                ...
                <div class="hidden md:flex items-center gap-8">
                    ...
                    <a href="{{ route('frontend.pricing') }}"
                        class="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-[#352f99] transition-colors">Harga</a>
                    <a href="{{ route('frontend.about') }}"
                        class="text-sm font-medium text-[#352f99] dark:text-white font-bold transition-colors">Tentang
                        Kami</a>
                </div>
